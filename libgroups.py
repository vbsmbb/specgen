...
class Grouping(object):
    def __init__(self, spec,ns):
        self.spec = spec
        self.gen = igraph.UniqueIdGenerator()
        self.ns = ns
    ...
    def processWalktrap(self,g):
        ...
        for i in range(0,len(dendro.merges)):
            membership = igraph.community_to_membership(dendro.merges,g.vcount(),i)
        ...
        membership = igraph.community_to_membership(dendro.merges,g.vcount(),maxIndex)
        return membership
